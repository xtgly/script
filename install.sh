...
opcache.memory_consumption=128      //�����ڴ���С, �����������ǵ������ɵ�
opcache.interned_strings_buffer=8   //interned string���ڴ���С, Ҳ�ɵ�
opcache.max_accelerated_files=4000  //���󻺴����ļ���Ŀ
opcache.revalidate_freq=60          //60s����һ���ļ�����
opcache.fast_shutdown=1             //�򿪿��ٹر�, ����������PHP Request Shutdown��ʱ�򣬻����ڴ����ٶȻ�����
opcache.save_comments=0             //�������ļ�/������ע��
EOF
    if [ -d $install_dir/apache ]; then
...
opcache.max_accelerated_files=4000  //���󻺴����ļ���Ŀ
opcache.revalidate_freq=60          //60s����һ���ļ�����
opcache.fast_shutdown=1             //�򿪿��ٹر�, ����������PHP Request Shutdown��ʱ��
                                    //   �����ڴ����ٶȻ�����
opcache.save_comments=0             //�������ļ�/������ע��
EOF
    elif [ "$verchoose" = "62" ]; then
...
# ��¼10000����ַ��ÿ����ַ60����
# ip_list_tot����Ϊ8100,����������ֵ�ᵼ��iptables����
